...
@Component({
  selector: 'comp-writing-items',
  templateUrl: './items.writing.component.html',
  styleUrls: ['./items.writing.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ItemsWritingComponent implements OnInit, OnChanges {
