...
export class MarkupWritingComponent implements OnInit, OnChanges, DoCheck {
  ...
  pageheight_desktop_12 = 800;
  pageheight_tablet_12 = 827;
  pageheight_mobile_12 = 1200;
  markup_height = 0;
  ...
  async onResizeDeviceCheck(markup){
    ...
    if((markup.clientWidth < 1200) && (markup.clientWidth > 600)) this.device = 'tablet';
    if(markup.clientWidth <= 600) this.device = 'mobile';
  }
